...
/*OnRadioTxDone << RadioEvents->TxDone( ); << SX1276OnDio0Irq << &SX1276.DIO0 PIN Interrupt*/
static void OnRadioTxDone( void )     
{
...
/*OnRadioTxDone << RadioEvents.RxDone << SX1276OnDio0Irq << &SX1276.DIO0 PIN Interrupt*/
static void OnRadioRxDone( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr )
{

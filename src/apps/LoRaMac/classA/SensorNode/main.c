...
/*!
 * User downlink application data
 */
uint8_t AppDownLinkData[LORAWAN_APP_DATA_MAX_SIZE];
...
static void McpsIndication( McpsIndication_t *mcpsIndication )
{
    ...
    if( mcpsIndication->RxData == true )
    {
        ...
        case 2:
            ...
            {	
								i = 0;
								while(mcpsIndication->Buffer[i] != '\0')
								{
										AppDownLinkData[i] = mcpsIndication->Buffer[i];
										i++;
								}
            }
            break;
